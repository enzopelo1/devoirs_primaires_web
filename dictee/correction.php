	...
	<div class="container mx-auto py-8 flex-grow">
		<div class="bg-white p-8 rounded-lg shadow-lg text-center min-h-[300px]">
			...
			<?php else: ?>
				...
				<h2 class="text-xl mb-4">La bonne réponse était : <?php echo $_POST['correction']; ?>.</h2>
			<?php endif; ?>
			<?php $_SESSION['historique'] .= $_POST['mot'] == $_POST['correction'] ? $_POST['correction'] : '********' . $_POST['mot'] . ';' . $_POST['correction'] . "\n"; ?>
