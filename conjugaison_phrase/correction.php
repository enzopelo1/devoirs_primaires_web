	...
	<div class="container mx-auto py-8 flex-grow">
		<div class="bg-white p-8 rounded-lg shadow-lg text-center min-h-[300px]">
			...
			<?php if ($_POST['mot'] == $_POST['correction']): ?>
				...
				<?php $_SESSION['historique'] .= $_POST['sujet'] . ' ' . $_POST['mot'] . ' ' . $_POST['finDePhrase'] . "\n"; ?>
			<?php else: ?>
				<h1 class="text-2xl font-bold text-red-600 mb-4">Oh non !</h1>
				<h2 class="text-xl mb-4">La bonne réponse était : <?php echo $_POST['sujet'] . ' ' . $_POST['correction'] . ' ' . $_POST['finDePhrase']; ?>.</h2>
				<?php $_SESSION['historique'] .= $_POST['sujet'] . ' ***' . $_POST['mot'] . '*** ' . $_POST['finDePhrase'] . ';' . $_POST['correction'] . "\n"; ?>
			<?php endif; ?>
